...
def S37():
    ...
    if ("gcc" == "iar" or "gcc" == ""):
        ...
        GCC_TOOLCHAIN_PATH = shortPath(r"file:/home/bryce/Desktop/SiLabs/SimplicityStudio_v4/developer/toolchains/gnu_arm/7.2_2017q4/".replace(
            "file:", "").replace("%20", " "))
...
def EBL():
    ...
    print " "
    EBL_COMMAND = START_FLAGS + shortPath(r"/home/bryce/Desktop/SiLabs/SimplicityStudio_v4/developer/adapter_packs/commander/commander").replace(
        " ", "\ ") + " ebl create " + EBL_FILE + " --app " + S37_BINARY + " --device mgm12p32f1024ge " + CONVERT_FLAGS
...
def GBL():
    ...
    GBL_COMMAND = START_FLAGS + shortPath(r"/home/bryce/Desktop/SiLabs/SimplicityStudio_v4/developer/adapter_packs/commander/commander").replace(
        " ", "\ ") + " gbl create " + GBL_FILE + " --app " + S37_BINARY + " --device mgm12p32f1024ge"
...
if (not "mgm12" or ("mgm12" and not "mgm12".startswith("EM3"))):
    S37()
