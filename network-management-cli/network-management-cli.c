...
void networkManagementInfoCommand(void)
{
  ...
  switch(SENSOR_SELECT_FLAG) {
  	  case 1: emberAfAppPrintln("Firmware : %p - NO2/SO2",EMBER_AF_DEVICE_NAME); break;
  	  case 2: emberAfAppPrintln("Firmware : %p - NO2/O3",EMBER_AF_DEVICE_NAME); break;
  	  default: emberAfAppPrintln("Firmware : %p - NO2/O3",EMBER_AF_DEVICE_NAME); break;
  }
/*  if(SENSOR_SELECT_FLAG == 1)
  {
	  emberAfAppPrintln("Firmware : %p - NO2/SO2",EMBER_AF_DEVICE_NAME);
  }
  else
	  emberAfAppPrintln("Firmware : %p - NO2/O3",EMBER_AF_DEVICE_NAME);*/
}
